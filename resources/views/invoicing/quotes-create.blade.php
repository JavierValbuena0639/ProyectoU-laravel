...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <form method="POST" action="{{ route('invoicing.quotes.store') }}" class="p-6" data-ajax="true" data-success-message="Cotización creada correctamente">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="client_document" name="client_document" placeholder="NIT/CC del cliente" 
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="client_address" name="client_address" rows="2" placeholder="Dirección del cliente"
